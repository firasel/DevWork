  ...
  return (
    <div className="price-container" id="price">
      <Space direction="vertical" align="center" style={{ width: "100%" }}>
        ...
        <p direction="vertical" align="center" style={{ width: "100%" }}>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil animi
          commodi a!Lorem <br /> ipsum dolor sit amet, consectetur adipisicing
          elit. Nihil animi commodi a!
        </p>
      </Space>
      <Row>
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width="100%" height="auto" src={Icon_1} />
          <Title level={3}>Shared Hosting</Title>
          <p>
            s <h1 className="price-number">34</h1>/mo{" "}
          </p>
          <p>
        ...
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width="100%" height="auto" src={Icon_2} />
        ...
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width="100%" height="auto" src={Icon_3} />
      ...
      <div className="price-text">
        <p>
          <span> see plan details </span>and piciln for more information
        </p>
      </div>
    </div>
  );
