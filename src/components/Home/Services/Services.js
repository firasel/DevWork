  ...
  return (
    <div className="serviceContainer" id="services">
      <Row justify="space-around">
        <Col span={24} md={{ span: 6, offset: 3 }}>
      ...
      <Row className="services-row">
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width={120} height={110} src={service_1} />
        ...
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width={120} height={110} src={service_2} />
        ...
        <Col
          ...
          xs={{ span: 24, offset: 0 }}
        >
          <Image width={120} height={110} src={service_3} />
